...
class QuestionController extends GetxController
  ...
  // animtating progress bat
  AnimationController _animationController;
  Animation _animation;
  // to access the animation outside
  ...
  bool get inAnswered => this._isAnswered;
  ...
  int get numOfCorrextAns => this._numOfCorrectAns;
  ...
  void nextQuestion() {
    if (_questionNumber.value != _questions.length) {
      ...
      // starting the counter again and moving to next Q
      _animationController.forward().whenComplete(nextQuestion);
    } else {
      Get.to(ResultScreen());
    }
